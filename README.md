...
- [ ] Заражение чумой - ВР <Чума>, увеличивает затрачивание времени в X раз, персонаж умирает через N дней
- [ ] Излечение чумой - ВР <Заражение чумой>, убирает эффект Заражение чумой.
...
- [ ] Открытие картошки - ВР<Семя жизни или смерти>. Игрок открывает неизвестный вид съедобного продукта.
- [ ] Отравление - ВР<Семя жизни или смерти>. Персонаж отравляется, затрачивание времени увеличино на N часов. 
Эффект спадет через X дней.
- [ ] Розовые очки въелись - ВР<Розовые очки>. вызывается с A% Карточка <сильные эмоции>. Затрачивание
времени снижается на Z время. 
- [ ] Розовые очки спали - ВР<Розовые очки>. Вызывается карточка <Сильные эмоции>. Затрачивание
...
- [ ] Еду можно купить, если у игрока есть оружие, он может подстрелить птиц и тем самым добыть еду.

![пример](https://a.nevomedia.ru/files/ru/games/pc/00/000/001/526/5_1526_1.jpg)
![пример](https://rg.ru/uploads/images/159/40/07/duckhunt-1000.jpg)
